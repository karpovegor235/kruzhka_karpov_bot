...
Следи за обновлениями!`
    ...
    // ✅ ИСПРАВЛЕНО: только кнопка "Назад к функциям"
...
👇 Хочешь увидеть, как выглядит мой создатель?`,
    ...
    // ✅ ИСПРАВЛЕНО: при нажатии "Назад к функциям" или "✅ Я всё поняла" - показываем список функций
    if (data === 'features_done' || data === 'back_to_features') {
        bot.deleteMessage(chatId, query.message.message_id);
        showBotFeatures(chatId);
        return;
    }
